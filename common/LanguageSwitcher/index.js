...
import CrossImage from "common/LanguageSwitcher/SwitcherButton/cross-btn.svg";
import LangImage from "common/LanguageSwitcher/SwitcherButton/language-btn.svg";
...
export default function LanguageSwitcher({ languageConfig }) {
  ...
  const handleSwitcher = useCallback(() => setShowSwitcher((showSwitcher) => !showSwitcher), []);
  ...
  return (
    <Wrapper ref={container}>
      ...
      >
        <img
          src={showSwitcher ? CrossImage.src : LangImage.src}
          alt="switcher"
        />
      </EnvatoButtonWrapper>
    </Wrapper>
